...
class ConnectionApi(models.Model):
    ...
    is_delete = fields.Boolean(string='DELETE',
                               help="Select this to enable DELETE method "
                                    "while sending requests.")
    input_param_get = fields.Html(string='Input Param')
    input_param_post = fields.Html(string='Input Param')
    input_param_modify = fields.Html(string='Input Param')
    input_param_del = fields.Html(string='Input Param')
